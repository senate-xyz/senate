                    ...
                    "blocks": [
                        {
                            ...
                            "text": {
                                "type": "mrkdwn",
                                "text": format!("*<{}|{}>*\n📢 New *{}* {} proposal ending on *<!date^1392734382^{{date}} at {{time}}|February 18th, 2014 at 6:39 AM PST>*", proposal.url, proposal.name,proposal.dao.name,if proposal.daohandler.r#type == DaoHandlerType::Snapshot {
                                        "offchain"
                                    } else {
                                        "onchain"
                                    })
