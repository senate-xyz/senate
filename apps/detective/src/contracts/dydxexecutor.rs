...
pub mod dydxexecutor {
                        ...
                        ::ethers::core::abi::ethabi::Function {
                            ...
                            inputs: ::std::vec![
                                ::ethers::core::abi::ethabi::Param {
                                    ...
                                    kind: ::ethers::core::abi::ethabi::ParamType::Address,
                                    internal_type: ::core::option::Option::Some(
                                        ::std::borrow::ToOwned::to_owned("contract IDydxGovernor"),
                                    ),
                                },
                                ::ethers::core::abi::ethabi::Param {
    ...
    pub static DYDXEXECUTOR_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(
        __abi,
    );
    ...
    impl<M> ::core::fmt::Debug for dydxexecutor<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(dydxexecutor))
                .field(&self.address())
                .finish()
        }
    }
