...
pub mod optimismgov {
    ...
    impl ::ethers::core::abi::AbiDecode for optimismgovCalls {
        fn decode(
            ...
            if let Ok(decoded)
                = <CancelWithModuleCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
            ...
            if let Ok(decoded)
                = <ExecuteWithModuleCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
            ...
            if let Ok(decoded)
                = <HashProposalWithDataCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
            ...
            if let Ok(decoded)
                = <ProposeWithModuleCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
            ...
            if let Ok(decoded)
                = <SetProposalDeadlineCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
