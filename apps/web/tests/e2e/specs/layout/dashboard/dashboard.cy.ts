...
describe('dashboard', () => {
    ...
    it('shows navbar', function() {
        ...
        cy.get('[href="/dashboard/settings"] > .flex > .text-sm').should('be.visible');
        cy.get('[href="/dashboard/settings"] > .flex > .text-sm').should('have.text', 'Settings');
        cy.get('[href="/dashboard/settings"] > .flex > .fill-slate-400').should('be.visible');
        cy.get('[href="/dashboard/proposals/active"] > .flex > .text-sm').should('have.text', 'Proposals');
        cy.get('[href="/dashboard/proposals/active"] > .flex > .text-sm').should('be.visible');
        cy.get('[href="/dashboard/proposals/active"] > .flex > .fill-slate-400').should('be.visible');
        cy.get('[href="/dashboard/daos"] > .flex > .text-sm').should('have.text', 'DAOs');
        cy.get('[href="/dashboard/daos"] > .flex > .text-sm').should('be.visible');
        cy.get('[href="/dashboard/daos"] > .flex > .fill-slate-400').should('be.visible');
        cy.get('[data-cy="navbar"]').should('be.visible');
    ...
    it('shows daos page', function() {
        ...
        cy.get('.h-full > :nth-child(1) > .w-full > :nth-child(1)').should('be.visible');
        cy.get('.h-full > :nth-child(1) > .w-full > :nth-child(2)').should('be.visible');
    ...
    it('shows active proposals page', function() {
        /* ==== Generated with Cypress Studio ==== */
        cy.get('[href="/dashboard/proposals/active"] > .flex > .fill-slate-400').click();
        cy.get('.h-48').should('be.visible');
        ...
        cy.get('[data-testid="rk-connect-button"]').should('have.text', 'Connect Wallet');
        ...
        cy.get('.h-48').click();
        cy.get('.mt-2 > :nth-child(1) > :nth-child(2) > .w-full').should('be.visible');
        /* ==== End Cypress Studio ==== */
        /* ==== Generated with Cypress Studio ==== */
    ...
    it('shows past proposals page', function() {
        /* ==== Generated with Cypress Studio ==== */
        cy.get('[href="/dashboard/proposals/active"] > .flex > .fill-slate-400 > path').click();
