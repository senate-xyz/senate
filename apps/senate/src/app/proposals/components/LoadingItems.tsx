      ...
      <div className="flex flex-col gap-1 lg:hidden">
        <div className="flex flex-col">
          <div className="w-full overflow-hidden bg-[#262626] p-2 shadow hover:shadow-md">
            <div className="flex w-full animate-pulse flex-row items-center gap-5">
              <div className="h-[46px] w-[46px] bg-[#545454]" />
          ...
          <div className="flex w-full flex-row gap-8 overflow-hidden bg-[#262626] p-2 shadow hover:shadow-md">
            <div className="flex grow animate-pulse bg-[#545454]" />
            <div className="h-8 w-8 animate-pulse rounded-full bg-[#545454]" />
          </div>
        </div>
        <div className="flex flex-col">
          <div className="w-full overflow-hidden bg-[#262626] p-2 shadow hover:shadow-md">
