...
export const NavBar = () => {
  ...
  return !pathname?.includes("verify") &&
    ...
    <div data-testid="navbar" className="flex min-h-screen min-w-[92px] flex-col items-center border border-y-0 border-l-0 border-[#545454] bg-black">
        ...
        <Link href={`/proposals/active`}>
          {pathname?.includes("proposals") ? (
            ...
            <div className="flex flex-col items-center">
              ...
              />
              <p className="text-[13px] text-gray-600">Proposals</p>
            </div>
          )}
        </Link>
        ...
        <Link href={`/settings/account`}>
          {pathname?.includes("settings") ? (
            ...
            <div className="flex flex-col items-center">
              ...
              />
              <p className="text-[13px] text-gray-600">Settings</p>
            </div>
          )}
        </Link>
      </div>
