...
import { ClerkProvider, SignInWithMetamaskButton } from '@clerk/nextjs'
                            ...
                            <div className='flex h-full w-full flex-row items-center justify-center '>
                                <div className='flex w-[40%] flex-col gap-3'>
                                    ...
                                    <div className='text-[15px] font-normal text-white'>
                                        Senate works best with your email
                                        address, so we can notify you of new
                                        proposals from the DAOs you follow.
                                    </div>
