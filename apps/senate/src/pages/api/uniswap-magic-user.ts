    ...
    if (existingUser) {
        if (
            ...
            emailClient.sendEmailWithTemplate({
                ...
                TemplateModel: {
                    ...
                    url: `${process.env.NEXT_PUBLIC_WEB_URL}/verify/subscribe-discourse/uniswap/${challengeCode}`
                }
            })
        ...
        emailClient.sendEmailWithTemplate({
            ...
            TemplateModel: {
                ...
                url: `${process.env.NEXT_PUBLIC_WEB_URL}/verify/signup-discourse/uniswap/${challengeCode}`
            }
        })
